...
export const ensureBaseDirectories = async () => {
    const paths = [config.databaseDir, config.raftDataDir, config.repoSandboxPath, config.deploymentPath, config.persistentPath, config.nginxConfDir, config.wwwPath];
